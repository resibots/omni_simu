...
private:
    void _initialize()
    {
        const std::vector<std::string> joint_names = {"ManipulatorL_Joint_0", "ManipulatorL_Joint_1", "ManipulatorL_Joint_2", "ManipulatorL_Joint_4"};
        ...
        const std::string end_effector_name = "Omnigrasper_EndEffector";
